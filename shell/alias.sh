...
if [ -n "${ZSH_VERSION:-}" ]; then
    ...
    alias -g zshrc='~/.zshrc'
    alias -g bashrc='~/.bashrc'
    alias -g vimrc='~/.vimrc'
    alias -g herdrconfig='~/.config/herdr/config.toml'
    alias -g agentsbconfig='~/.config/agentsb/config.toml'
    alias -g gitconfig='~/.gitconfig'
    alias -g gitconfiglocal='~/.gitconfig.local'
    alias -g gitignore='~/.config/git/ignore'
    alias -g aliassh='~/shell/alias.sh'
    alias -g envsh='~/shell/env.sh'
    alias -g fzfsh='~/shell/fzf.sh'
    alias -g claudemd='~/.claude/CLAUDE.md'
    alias -g agentsmd='~/.codex/AGENTS.md'
    alias -g claudesettings='~/.claude/settings.json'
    alias -g claudesettingssandbox='~/.claude/settings.sandbox.json'
    alias -g codexconfig='~/.codex/config.toml'
